...
use App\Filament\Resources\SpeciallabsResource\Pages;
use App\Models\Speciallabs;
use Filament\Forms;
...
use App\Filament\Resources\SpeciallabsResource\Pages\EditUser;
use App\Filament\Resources\SpeciallabsResource\Pages\ListUsers;
use App\Filament\Resources\SpeciallabsResource\Pages\CreateUser;
...
class SpeciallabsResource extends Resource
{
    protected static ?string $model = Speciallabs::class;
    ...
    {
        return [
            'index' => Pages\ListSpeciallabs::route('/'),
            'create' => Pages\CreateSpeciallabs::route('/create'),
            'edit' => Pages\EditSpeciallabs::route('/{record}/edit'),
        ];
    }
}
